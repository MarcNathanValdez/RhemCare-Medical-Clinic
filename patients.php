...
if (isset($_POST['save_Patient'])) {
    ...
    $gender = $_POST['gender'];
        ...
        if ($patientName != '' && $address != '' && $email != '' && $dateOfBirth != '' && $phoneNumber != '' && $gender != '') {
            $query = "INSERT INTO patients(patient_name, address, email, date_of_birth, phone_number, gender) VALUES ('$patientName', '$address', '$email', '$dateOfBirth', '$phoneNumber', '$gender');";
...
try {
    $query = "SELECT id, patient_name, address, email, date_format(date_of_birth, '%d %b %Y') as date_of_birth, phone_number, gender FROM patients ORDER BY id DESC;";
                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    ...
                                    <input type="text" id="patient_name" name="patient_name" required="required" autocomplete="off" class="form-control form-control-sm rounded-0"/>
                                </div>
                                <br>
                                <br>
                                <br>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>Address</label> 
                                    <input type="text" id="address" name="address" required="required" autocomplete="off" class="form-control form-control-sm rounded-0"/>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>Email</label>
                                    <input type="email" id="email" name="email" required="required" autocomplete="off" class="form-control form-control-sm rounded-0"/>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    ...
                                    <input type="text" id="phone_number" name="phone_number" required="required" autocomplete="off" class="form-control form-control-sm rounded-0"/>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                                    <label>Gender</label>
